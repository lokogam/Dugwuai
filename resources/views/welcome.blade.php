        ...
        <div class="col-12">
            <div class="d-flex justify-content-end">
                @if (Route::has('login'))
                    <div class="">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-muted btn btn-info">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="text-muted btn btn-info">Log in</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="ms-4 text-muted btn btn-info">Register</a>
                            @endif
                        @endif
                    </div>
                @endif
